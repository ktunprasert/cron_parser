...
def test_parse_field():
    ...
    assert parse_field("Mon-Fri", CronField.WEEKDAY) == [0, 1, 2, 3, 4]
    assert parse_field("Mon-3", CronField.WEEKDAY) == [0, 1, 2, 3]
    assert parse_field("1-12/3", CronField.WEEKDAY) == [1, 4, 7, 10]
